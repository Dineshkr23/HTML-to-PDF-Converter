  ...
  <body>
    <div class="invoice-container">
      ...
      <div class="total-data-container">
        ...
        <div>
          ...
          <div id="tax-details" class="total-divider">
            ...
            <div class="total">
              <p class="total-data">
                ${item.taxName.toLocaleUpperCase()} (${item.percentage}%)
              </p>
      ...
      >
        ...
        <div class="footer-image">
          <a href="https://emovur.com"
            ><img
              id="footerLogo"
              src="${data.partnerProfile.extra.logo}"
              alt="Footer Logo"
            />
          </a>
        </div>
    ...
    <script>
      ...
      function populatePlaceholders() {
        ...
        data.items.forEach((item, index) => {
          ...
          if (index === 0) {
            row.style.backgroundColor = "#f0f0f0"; // Light gray color
          }

          // Create each cell dynamically
          Object.values(item).forEach((value) => {
            const cell = document.createElement("td");
            cell.textContent = value;
            cell.style.textAlign = "right"; // Align content to the right
        ...
        document.getElementById("partnerLogo").src =
